...
const Process: React.FC = () => {
  return (
    <section className="bg-white py-12 px-6 flex flex-col justify-center items-center">
      <h1 className="text-3xl font-semibold mb-8 max-w-2xl text-center">
      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="w-full md:w-1/2">
          {/* Subheading */}
          <h3 className="text-xl font-bold mb-2">360° Payroll Management</h3>
          {/* Description */}
