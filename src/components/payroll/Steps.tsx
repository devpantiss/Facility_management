      ...
      <div className="container mx-auto text-center px-6">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-0">
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <h3 className="font-bold text-[#22C55E] mb-2">Create an Account</h3>
          ...
          {/* Line Connector */}
          <div className="hidden md:block flex-1 border-t-2 border-green-500"></div>
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <h3 className="font-bold text-[#22C55E] mb-2">Onboard Your Workforce</h3>
            <p className="text-white text-sm">
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <h3 className="font-bold text-[#22C55E] mb-2">Run Payroll!</h3>
            <p className="text-white text-sm">
