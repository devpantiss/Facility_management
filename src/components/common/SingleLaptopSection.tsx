...
const SingleLaptopSection: React.FC = () => {
  return (
    <div className="px-12 py-10 flex justify-center items-center bg-black gap-x-2">
      {/* Laptop */}
      <div className="relative">
        <div className="absolute -top-16 rounded-full border-[4px] border-dotted border-green-500 h-[300px] w-[300px] animate-spin-clockwise"></div>
...
export default SingleLaptopSection;
