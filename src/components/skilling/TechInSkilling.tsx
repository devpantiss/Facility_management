...
const TechInSkilling: React.FC = () => {
  return (
    <div className="container mx-auto flex flex-col justify-center items-center lg:flex-row py-10">
      ...
      <div className="lg:w-1/2 w-full py-6">
        ...
        <p className="mt-2">
          ...
          cultivating enlightenment and vigilance, thereby ensuring a sanctuary
          of safety for our personnel and patrons alike.
        </p>

        <p className="mt-4">
          <strong>Endorsement through Independent Scrutiny: </strong>Our commitment to eclipsing
          the zenith of quality is validated through external assessments by
          third-party auditors. This rigorous examination of our quality
          benchmarks ascertains that we not only meet but exceed the
          anticipations of our clientele, perpetuating a hallmark of unrivaled
          quality standards.
        </p>
      </div>
    </div>
